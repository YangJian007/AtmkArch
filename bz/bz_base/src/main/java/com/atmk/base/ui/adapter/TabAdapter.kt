package com.atmk.base.ui.adapter
...
class TabAdapter @JvmOverloads constructor(
    ...
    /** Tab fixe样式的布局,非固定的样式暂且不支持，如有需求，可参考修改 */
    private val fixTabLayoutId: Int = R.layout.tab_item_design
    ...
    inner class DesignViewHolder : AppViewHolder(fixTabLayoutId) {

        private val titleView: ShapeTextView? by lazy { findViewById(R.id.tv_tab_design_title) }
