...
import com.atmk.appupdate.widget.UpdateDialog;
...
public class AppUpdateManager {
    ...
    public static class Builder {
        ...
        private String apkVersionNum;//apk目前版本
        private String apkId;//apkId
...
//        private boolean breakpoint;//是否支持断点下载，默认不支持（针对访问接口获取文件流的下载方式）
         ...
         * 设置目前版本号
         */
        public Builder apkVersionNum(String versionNum) {
            this.apkVersionNum = versionNum;
            return this;
        }
         ...
         * 设置apkId
         */
        public Builder apkId(String apkId) {
            this.apkId = apkId;
            return this;
        }
